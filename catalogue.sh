...
cp /home/centos/roboshop-shell-tf-master/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp /home/centos/roboshop-shell-tf-master/mongo.repo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
